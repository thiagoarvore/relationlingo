...
class DailyReport(BaseModel):
    reporter = models.ForeignKey(user_model, on_delete=models.CASCADE, related_name='reports_as_reporter')
    subject = models.ForeignKey(user_model, on_delete=models.CASCADE, related_name='reports_as_subject')
